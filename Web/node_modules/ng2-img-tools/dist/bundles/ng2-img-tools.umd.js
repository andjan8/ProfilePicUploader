(function (global, factory) {
	...
	(factory((global['ng2-img-tools'] = {}),global.ng.core,global.Rx,global.ng2ImgMax));
...
var ImgCropService = (function () {
    ...
    ImgCropService.ctorParameters = function () { return [
        { type: ng2ImgMax.Ng2ImgMaxService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ng2ImgMax.Ng2ImgMaxService; }),] },] },
    ]; };
...
var ImgResizeExactService = (function () {
    ...
    ImgResizeExactService.ctorParameters = function () { return [
        { type: ng2ImgMax.Ng2ImgMaxService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ng2ImgMax.Ng2ImgMaxService; }),] },] },
        { type: ImgCropService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ImgCropService; }),] },] },
    ]; };
...
var Ng2ImgToolsService = (function () {
    ...
    Ng2ImgToolsService.ctorParameters = function () { return [
        { type: ImgResizeExactService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ImgResizeExactService; }),] },] },
        { type: ng2ImgMax.Ng2ImgMaxService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ng2ImgMax.Ng2ImgMaxService; }),] },] },
        { type: ImgCropService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ImgCropService; }),] },] },
    ]; };
